...
public class wealthBuilder extends JxFrame 
  implements ListSelectionListener, ActionListener {
    ...
    private Vector Bonds, Stocks, Mutuals, Japanese;   //3 lists of investments
    ...
    private void buildStockLists() {
        ...
        Japanese = new Vector();
        Japanese.addElement("Sony");
        Japanese.addElement("Mitsubishi");
        Japanese.addElement("Toyota");
        Japanese.addElement("Honda");
        Japanese.addElement("Panasonic");
